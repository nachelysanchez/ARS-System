        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AfiliadoId = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2021, 12, 6, 14, 7, 22, 510, DateTimeKind.Local).AddTicks(2883), "Duarte" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Consulta", new DateTime(2021, 12, 6, 14, 7, 22, 518, DateTimeKind.Local).AddTicks(1323), 0 });

            migrationBuilder.InsertData(
                table: "Servicios",
                columns: new[] { "ServicioId", "Descripcion", "Fecha", "VecesAsignado" },
                values: new object[] { 2, "Emergencia", new DateTime(2021, 12, 6, 14, 7, 22, 518, DateTimeKind.Local).AddTicks(4858), 0 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1, new DateTime(2021, 12, 6, 14, 7, 22, 519, DateTimeKind.Local).AddTicks(6755), 845632, 52361, 1, 0f });

...
namespace ARS_System.Migrations
{
    ...
    [Migration("20211206180726_Migracion_Inicial")]
            ...
            modelBuilder.Entity("ARS_System.Entidades.Provincias", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProvinciaId = 1,
                            Fecha = new DateTime(2021, 12, 6, 14, 7, 22, 510, DateTimeKind.Local).AddTicks(2883),
                            Nombres = "Duarte"
                        });
                });
            ...
            modelBuilder.Entity("ARS_System.Entidades.Reclamaciones", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AfiliadoId = 1,
                            DoctorId = 1,
                            Fecha = new DateTime(2021, 12, 6, 14, 7, 22, 519, DateTimeKind.Local).AddTicks(6755),
                            NAF = 845632,
            ...
            modelBuilder.Entity("ARS_System.Entidades.Servicios", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Fecha = new DateTime(2021, 12, 6, 14, 7, 22, 518, DateTimeKind.Local).AddTicks(1323),
                            VecesAsignado = 0
                        },
                        new
                        {
                            ...
                            Fecha = new DateTime(2021, 12, 6, 14, 7, 22, 518, DateTimeKind.Local).AddTicks(4858),
                            VecesAsignado = 0
                        });
                });
